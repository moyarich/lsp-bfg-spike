...
for i in gva-w{1..16}; do ssh ${i} "hostname; ps -ef | grep [j]ava |  wc -l "; done >> ./performance_tpch_10g_16.log
sleep 300 
...
hawq cluster stop -M fast >>./performance_tpch_10g_15hawq.log   2>&1
hawq cluster start   >>./performance_tpch_10g_15hawq.log  2>&1
./nodeconfig.sh stop HAWQ "gva-w16" >>./performance_tpch_10g_15hawq.log  2>&1
for i in gva-w{1..16}; do ssh ${i} "hostname; ps -ef | grep [j]ava |  wc -l "; done  >>./performance_tpch_10g_15hawq.log 2>&1
sleep 300
...
hawq cluster start
./nodeconfig.sh stop HDFS "gva-w16" >>./performance_tpch_10g_15hdfs.log 2>&1
./nodeconfig.sh start HAWQ "gva-w16" >>./performance_tpch_10g_15hdfs.log 2>&1
for i in gva-w{1..16}; do ssh ${i} "hostname; ps -ef | grep [j]ava |  wc -l "; done >>./performance_tpch_10g_15hdfs.log 2>&1
sleep 300
...
hawq cluster stop -M fast  >>./performance_tpch_10g_15both.log 2>&1
hawq cluster start       >>./performance_tpch_10g_15both.log 2>&1
./nodeconfig.sh stop BOTH "gva-w16" >>./performance_tpch_10g_15both.log 2>&1
for i in gva-w{1..16}; do ssh ${i} "hostname; ps -ef | grep [j]ava |  wc -l "; done >>./performance_tpch_10g_15both.log 2>&1
sleep 300
...
hawq cluster stop -M fast >> ./performance_tpch_10g_14hawq.log 2>&1
hawq cluster start >> ./performance_tpch_10g_14hawq.log 2>&1
./nodeconfig.sh stop HAWQ "gva-w16 gva-w15" >> ./performance_tpch_10g_14hawq.log 2>&1
./nodeconfig.sh start HDFS "gva-w16" >> ./performance_tpch_10g_14hawq.log 2>&1
for i in gva-w{1..16}; do ssh ${i} "hostname; ps -ef | grep [j]ava |  wc -l "; done >> ./performance_tpch_10g_14hawq.log 2>&1
sleep 300
...
hawq cluster stop -M fast >> ./performance_tpch_10g_14hdfs.log 2>&1
hawq cluster start >> ./performance_tpch_10g_14hdfs.log 2>&1
./nodeconfig.sh stop HDFS "gva-w16 gva-w15" >> ./performance_tpch_10g_14hdfs.log 2>&1
./nodeconfig.sh start HAWQ "gva-w16 gva-w15" >> ./performance_tpch_10g_14hdfs.log 2>&1
for i in gva-w{1..16}; do ssh ${i} "hostname; ps -ef | grep [j]ava |  wc -l "; done >> ./performance_tpch_10g_14hdfs.log 2>&1
sleep 300
...
hawq cluster stop -M fast  >> ./performance_tpch_10g_14both.log 2>&1
hawq cluster start  >> ./performance_tpch_10g_14both.log 2>&1
./nodeconfig.sh stop BOTH "gva-w16 gva-w15"  >> ./performance_tpch_10g_14both.log 2>&1
for i in gva-w{1..16}; do ssh ${i} "hostname; ps -ef | grep [j]ava |  wc -l "; done  >> ./performance_tpch_10g_14both.log 2>&1
sleep 300
...
hawq cluster stop -M fast    >> ./performance_tpch_10g_8hawq.log 2>&1
hawq cluster start   >> ./performance_tpch_10g_8hawq.log 2>&1
./nodeconfig.sh stop HAWQ "gva-w16 gva-w15 gva-w14 gva-w13 gva-w12 gva-w11 gva-w10 gva-w9"   >> ./performance_tpch_10g_8hawq.log 2>&1
./nodeconfig.sh start HDFS "gva-w16 gva-w15"   >> ./performance_tpch_10g_8hawq.log 2>&1
for i in gva-w{1..16}; do ssh ${i} "hostname; ps -ef | grep [j]ava |  wc -l "; done   >> ./performance_tpch_10g_8hawq.log 2>&1
sleep 300
...
hawq cluster stop -M fast >> ./performance_tpch_10g_8hdfs.log 2>&1
hawq cluster start >> ./performance_tpch_10g_8hdfs.log 2>&1
./nodeconfig.sh stop HDFS "gva-w16 gva-w15 gva-w14 gva-w13 gva-w12 gva-w11 gva-w10 gva-w9" >> ./performance_tpch_10g_8hdfs.log 2>&1
./nodeconfig.sh start HAWQ "gva-w16 gva-w15 gva-w14 gva-w13 gva-w12 gva-w11 gva-w10 gva-w9" >> ./performance_tpch_10g_8hdfs.log 2>&1
for i in gva-w{1..16}; do ssh ${i} "hostname; ps -ef | grep [j]ava |  wc -l "; done >> ./performance_tpch_10g_8hdfs.log 2>&1
sleep 300
...
hawq cluster stop -M fast  >> ./performance_tpch_10g_8both.log 2>&1
hawq cluster start  >> ./performance_tpch_10g_8both.log 2>&1
./nodeconfig.sh stop BOTH "gva-w16 gva-w15 gva-w14 gva-w13 gva-w12 gva-w11 gva-w10 gva-w9"  >> ./performance_tpch_10g_8both.log 2>&1
for i in gva-w{1..16}; do ssh ${i} "hostname; ps -ef | grep [j]ava |  wc -l "; done  >> ./performance_tpch_10g_8both.log 2>&1
sleep 300
