...
class Workload(object):
    def __init__(self, workload_specification, workload_directory, report_directory, report_sql_file, cs_id):
        ...
        # get table suffix, sql suffix, check_condition, wl_valuse from table_settings
        self.tbl_suffix = ''
        self.sql_suffix = ''      
        ...
        if self.append_only in [None, True]:
            ...
            if self.orientation in ['ROW', 'COLUMN']:
                ...
                if self.compression_type is None:
                    ...
                    self.check_condition += " and wl_compression_type = '%s' and wl_compression_level = 1" % (self.compression_type)
                    self.wl_values += ", '%s', 1" % (self.compression_type)
                ...
                if self.compression_level == 'SNAPPY':
                    ...
                    self.wl_values += ", '%s', 1048576, NULL" % (self.compression_type)
