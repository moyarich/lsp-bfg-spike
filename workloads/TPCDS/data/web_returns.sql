DROP TABLE IF EXISTS web_returns_TABLESUFFIX CASCADE;
DROP EXTERNAL TABLE IF EXISTS e_web_returns_TABLESUFFIX;

create table web_returns_TABLESUFFIX
(
...
CREATE EXTERNAL TABLE e_web_returns_TABLESUFFIX
(
wr_returned_date_sk       integer                       ,
wr_returned_time_sk       integer                       ,
wr_item_sk                integer               ,
...
INSERT INTO web_returns_TABLESUFFIX SELECT * FROM e_web_returns_TABLESUFFIX;