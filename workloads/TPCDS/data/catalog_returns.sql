DROP TABLE IF EXISTS catalog_returns_TABLESUFFIX CASCADE;
DROP EXTERNAL TABLE IF EXISTS e_catalog_returns_TABLESUFFIX;

create table catalog_returns_TABLESUFFIX
(
...
CREATE EXTERNAL TABLE e_catalog_returns_TABLESUFFIX
(
cr_returned_date_sk       integer                       ,
cr_returned_time_sk       integer                       ,
cr_item_sk                integer               ,
...
INSERT INTO catalog_returns_TABLESUFFIX SELECT * FROM e_catalog_returns_TABLESUFFIX;