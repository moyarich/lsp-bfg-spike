DROP TABLE IF EXISTS web_sales_TABLESUFFIX CASCADE;
DROP EXTERNAL TABLE IF EXISTS e_web_sales_TABLESUFFIX;

create table web_sales_TABLESUFFIX
(
...
CREATE EXTERNAL TABLE e_web_sales_TABLESUFFIX
(
ws_sold_date_sk           integer                       ,
ws_sold_time_sk           integer                       ,
ws_ship_date_sk           integer                       ,
...
INSERT INTO web_sales_TABLESUFFIX SELECT * FROM e_web_sales_TABLESUFFIX;