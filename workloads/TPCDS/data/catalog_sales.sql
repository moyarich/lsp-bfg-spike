DROP TABLE IF EXISTS catalog_sales_TABLESUFFIX CASCADE;
DROP EXTERNAL TABLE IF EXISTS e_catalog_sales_TABLESUFFIX;

create table catalog_sales_TABLESUFFIX
(
...
CREATE EXTERNAL TABLE e_catalog_sales_TABLESUFFIX
(
cs_sold_date_sk           integer                       ,
cs_sold_time_sk           integer                       ,
cs_ship_date_sk           integer                       ,
...
INSERT INTO catalog_sales_TABLESUFFIX SELECT * FROM e_catalog_sales_TABLESUFFIX;