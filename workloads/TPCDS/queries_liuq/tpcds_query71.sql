--@author guz4
--@description TPC-DS tpcds_query71
...
select i_brand_id brand_id, i_brand brand,t_hour,t_minute,
 ...
 from item_TABLESUFFIX, (select ws_ext_sales_price as ext_price, 
                        ws_sold_date_sk as sold_date_sk,
                        ws_item_sk as sold_item_sk,
                        ws_sold_time_sk as time_sk  
                 from web_sales_TABLESUFFIX,date_dim_TABLESUFFIX
 ...
 order by ext_price desc, i_brand_id, brand, t_hour, t_minute;
 ;
