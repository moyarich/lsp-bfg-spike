...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and (date_dim_TABLESUFFIX.d_dom between 1 and 3 or date_dim_TABLESUFFIX.d_dom between 25 and 28)
    ...
    and (case when household_demographics_TABLESUFFIX.hd_vehicle_count > 0 
	then household_demographics_TABLESUFFIX.hd_dep_count/ household_demographics_TABLESUFFIX.hd_vehicle_count 
	else null 
	end)  > 1.2
    ...
    group by ss_ticket_number,ss_customer_sk) dn,customer_TABLESUFFIX
