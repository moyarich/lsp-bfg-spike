--@author guz4
--@description TPC-DS tpcds_query29
...
select   
    ...
    ,s_store_id
    ,s_store_name
    ,sum(ss_quantity)        as store_sales_TABLESUFFIX_quantity
    ,sum(sr_return_quantity) as store_returns_TABLESUFFIX_quantity
    ,sum(cs_quantity)        as catalog_sales_TABLESUFFIX_quantity
 from
