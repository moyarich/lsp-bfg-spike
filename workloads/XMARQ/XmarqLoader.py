...
try:
    ...
    sys.stderr.write('LSP needs psql in lib/PSQL.py in XmarqLoader.py\n')
    sys.exit(2)
...
class XmarqLoader(object):
    ...
    def __init__(self, database_name = 'gpadmin', user = 'gpadmin', \
        ...
        tbl_suffix = '', sql_suffix = '', output_file = '/tmp/Xmarq_output', report_file = '/tmp/Xmarq_report', \
