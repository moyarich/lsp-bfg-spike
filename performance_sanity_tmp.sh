...
sleep 10
python -u lsp.py -s performance_tpch_200g_sanity -m 30 -a   > ./performance_tpch_200g.log 2>&1
sleep 10
python -u lsp.py -s performance_tpch_concurrent_sanity -m 60 -a  > ./performance_tpch_concurrent.log 2>&1
sleep 10
#4. 2. 1 ratio concurrent to run tpch 10G 
python -u lsp.py -s resourcequene_tpch_ratio_10g -m 30 -a   > ./resourcequene_tpch_ratio_10g 2>&1

python -u lsp.py -s tpcds_sanity -m 10 -a  -r 5 > ./tpcds 2>&1
sleep 10
