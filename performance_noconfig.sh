...
./nodeconfig.sh stop NAMENODE "gva-mst2 gva-mst1"  >> ./performance_tpch_nodechange_8.log 2>&1
./nodeconfig.sh start NAMENODE "gva-mst2 gva-mst1"  >> ./performance_tpch_nodechange_8.log 2>&1
...
echo '#################################################'
hawq stop cluster -M fast  > ./performance_tpch_nodechange_16node.log 2>&1 
hawq start cluster  >> ./performance_tpch_nodechange_16node.log 2>&1
...
sudo -u hdfs  /usr/phd/current/hadoop-client/bin/hdfs dfsadmin -report -live  >> ./performance_tpch_nodechange_16node.log 2>&1
...
hawq stop cluster -M fast >>./performance_tpch_nodechange_15hawq.log   2>&1
hawq start cluster   >>./performance_tpch_nodechange_15hawq.log  2>&1
...
hawq stop cluster -M fast  >>./performance_tpch_nodechange_15both.log 2>&1
hawq start cluster       >>./performance_tpch_nodechange_15both.log 2>&1
...
hawq stop cluster -M fast >> ./performance_tpch_nodechange_14hawq.log 2>&1
hawq start cluster >> ./performance_tpch_nodechange_14hawq.log 2>&1
...
hawq stop cluster -M fast >> ./performance_tpch_nodechange_14hdfs.log 2>&1
hawq start cluster >> ./performance_tpch_nodechange_14hdfs.log 2>&1
...
hawq stop cluster -M fast  >> ./performance_tpch_nodechange_14both.log 2>&1
hawq start cluster  >> ./performance_tpch_nodechange_14both.log 2>&1
...
hawq stop cluster -M fast    >> ./performance_tpch_nodechange_8hawq.log 2>&1
hawq start cluster   >> ./performance_tpch_nodechange_8hawq.log 2>&1
...
hawq stop cluster -M fast >> ./performance_tpch_nodechange_8hdfs.log 2>&1
hawq start cluster >> ./performance_tpch_nodechange_8hdfs.log 2>&1
...
hawq stop cluster -M fast  >> ./performance_tpch_nodechange_8both.log 2>&1
hawq start cluster  >> ./performance_tpch_nodechange_8both.log 2>&1
